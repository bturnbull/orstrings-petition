...
describe ApplicationHelper do
  ...
  describe 'friendly_time' do
    ...
    it 'should return day of week and time for couple days past times' do
      friendly_time(2.days.ago).should eq(2.days.ago.in_time_zone(Rails.configuration.display_time_zone).strftime('on %A around %l %p'))
    end

    it 'should return day of week, date, and time for older past times' do
      friendly_time(7.days.ago).should eq(7.days.ago.in_time_zone(Rails.configuration.display_time_zone).strftime('on %A, %B %-d around %l %p'))
    end
  end
  ...
  describe 'friendly_date' do
    ...
    it 'should return the date in friendly format' do
      friendly_date(1.day.ago).should eq(1.day.ago.in_time_zone(Rails.configuration.display_time_zone).strftime("%A, %B %-d %Y"))
    end
  end
end
